...
public class SlotController {
    ...
    public HoldSlotResponse hold(@PathVariable UUID slotId, @Valid @RequestBody HoldSlotRequest req) {
    ...
    public void confirm(@PathVariable UUID slotReservationId, @Valid @RequestBody ConfirmByBookingRequest req) {
        slotService.confirmHold(slotReservationId, req.getBookingId());
    }

    @PostMapping("/slot-holds/{slotReservationId}/cancel")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void cancel(@PathVariable UUID slotReservationId, @Valid @RequestBody ConfirmByBookingRequest req) {
